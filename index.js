...
var handleInput_1 = __importDefault(require("./lib/src/handlers/handleInput"));
var handleFinish_1 = __importDefault(require("./lib/src/handlers/handleFinish"));
 ...
 * @param  {Boolean} filter          Vuln level filter
 */
function callback(auditCommand, auditLevel, exceptionIds, filter) {
    ...
    if (audit.stderr) {
        audit.stderr.on('close', function () { return handleFinish_1.default(jsonBuffer, auditLevel, exceptionIds, filter); });
        // stderr
